...
public class OrganiserInitiater {
    ...
    public ResponseEntity<Object> organizeShoppingList(@RequestBody List<String> items) {
        Map<String, List<String>> organisedJson = organiserService.organisedList(items);
